...
// PC + mobaile 메뉴 클릭시 애니메이션으로 위치 이동
// .menu와 .m_menu의 a 태그 속성 중 href의 #으로 시작하는 요소
...
$(window).scroll(function(){  // .scroll - 스크롤 이밴트
...
//레드카펫2
    //스크롤 위치가 1630픽셀 이상인 경우 추가 스타일 적용
    //scr 1630px보다 큰지 확인후
    //해당 조건이 참일 경우 scr에서 1630px을 빼줌
    //이렇게 하는 이유는,
    //상단에
    if (scr > 1630) {
        scr -= 1630;
